...
(function ($) {
  ...
  Drupal.behaviors.toc_js = {
    attach: function(context, settings) {
      ...
      // Hide toc (and the title) if no heading found.
      $('.toc-js', context).each(function () {
      ...
      $('.toc-js.sticky', context).each(function () {
        ...
        $(window).scroll(function () {
          var toolbarHeight = $('.toolbar-tray-horizontal').innerHeight();
          var windowTop = $(window).scrollTop();
          if (stickyTop + toolbarHeight < windowTop + stickOffset) {
            $sticky.css({top: stickOffset}).addClass('is-sticked');
          }
          else {
            $sticky.css({top: 'initial'}).removeClass('is-sticked');
          }
        });
